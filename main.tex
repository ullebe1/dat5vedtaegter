...
\begin{document}
	...
	Alle afstemninger afgøres enten ved håndsoprækning og almindeligt flertal ved holdets time eller ved at spin med Juhl Juhl Binx. Afstemninger kan have så mange mulige udfald, som initiativtageren til afstemningen synes. Dog mindst 2. Da afstemninger er d'ary, kan alle stemme på alle udfald. Er der stemmelighed løses dette ved Kamp til Døden\textsuperscript{TM}.
	...
	\subsection{}
	Har man lavet et punkt uden indhold, så skal den person som kom med punktet tage en straf besluttet med farvesystemet fra Juhl Juhl Binx.
	...
	\section{Juhl Juhl Binx}
	Juhl Juhl Binx er et elektronisk dødshjul designet og konstrueret af Oskar Harklou Veileborg. Det kan bruges til at indføre midlertidige regler til holdets time.
	\subsection{Regler}
	En regel indført vha. Juhl Juhl Binx er gældende resten af den holdets time den er indført + den næste, dog ikke i perioden imellem disse.
	\subsection{Farver}
	\subsubsection{Grøn}
	Grøn betyder at reglen er gået igennem samt at forslagsstilleren skal have kage med til næste holdets time, ud over den person som blev besluttet ved Kage NU. 
	\subsubsection{Gul}
